...
window.onload = function () {
    ...
    function drawIncidentRays() {
        ...
        var x = d * Math.sin(radians)
        var y = d * Math.cos(radians)
        ...
        ctx.moveTo(XRAY_SOURCE_X, REFLECTION_POINT[1] + y)
        ctx.lineTo(REFLECTION_POINT[0] + x, REFLECTION_POINT[1] + y)
        ctx.stroke()
    ...
    function drawRefractedRays() {
        ...
        var topXRayLength = REFLECTION_POINT[0] - XRAY_SOURCE_X //Calculate the length of the top incident X-ray, because it is at 0 degrees no pythag needed.
        var bottomXRayLength = REFLECTION_POINT[0] + x - XRAY_SOURCE_X   //Calculate the length of the bottom incident X-ray, because it is at 0 degrees no pythag needed.
        ...
        ctx.moveTo(REFLECTION_POINT[0] + x, REFLECTION_POINT[1] + y)
        ctx.lineTo(REFLECTION_POINT[0] + x + bottomXDisplacement, REFLECTION_POINT[1] - bottomYDisplacement + y)
        ctx.stroke()

        refractedCoords = { 
            x: REFLECTION_POINT[0] + x + bottomXDisplacement, 
            y: REFLECTION_POINT[1] - bottomYDisplacement + y
        }
    ...
    function draw_xray_passthrough() {
        ...
        ctx.beginPath()
        ctx.moveTo(REFLECTION_POINT[0] + x, REFLECTION_POINT[1] + y)
        ctx.lineTo(REFLECTION_POINT[0] + x + bottomXRayLength, REFLECTION_POINT[1] + y)

        passthroughCoords = {
            x: REFLECTION_POINT[0] + x + bottomXRayLength,
            y: REFLECTION_POINT[1] + y
        }
        ctx.stroke()
    }
    ...
    function output() {
        ...
        ctx.beginPath()
        ctx.arc(DETECTOR_POSITION + (DETECTOR_WIDTH/2) - deltaPos.x, SECOND_XRAY_Y - deltaPos.y, 2, 0, 2 * Math.PI)
        ctx.stroke()
    }
